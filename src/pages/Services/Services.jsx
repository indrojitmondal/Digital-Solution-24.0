...
const Services = () => {
    return (
        <div>
             <Helmet>
              <title>Services – Digital Solution 24.0 </title>
              </Helmet>
            <section className="">
                <div className="w-11/12 md:w-10/12 mx-auto text-center flex flex-col lg:flex-row gap-8 pt-9 md:px-14 pb-9">
                    ...
                    <div className="text-center">
                        <h1 className=" font-bold text-primary pt-5">
                            <span className="text-primary font-bold">OUR</span> SERVICES
                        </h1>
                        <p className=" text-justify text-base ">
                        As a dedicated web development company, we specialize in providing a wide range of services to meet your digital needs. From designing responsive and user-friendly websites to developing robust, high-performance web applications, we focus on delivering tailored solutions that help you succeed online. With a commitment to modern technologies and best practices, we ensure high-quality results for every project 
                        </p>
                    </div>
                </div>
                        ...
                        <div className="frontEnd">
                            ...
                            <div className=" grid grid-cols-1 md:grid-cols-2 ">
                                <div className="pt-2 pl-4 text-justify text-base">
                                    <h2>✓ Developing the user interface.</h2>
